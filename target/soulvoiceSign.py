...
class signClass(signBase):
    def __init__(self, driver, url = 'https://pt.soulvoice.club/index.php', module_name: str = 'soulvoiceSign'):
        self.indexUrl = url
        self.driver = driver
        self.module_name = module_name
        super().__init__("soulvoice")
    ...
    def sign(self):
        ...
        for element in elements:
            if element.text == '[签到得魔力]' and 'attendance.php' in element.get_attribute("href"):
                ...
                break
    def validSign(self):
        if not re.search('聆音.*NexusPHP', self.driver.title):
