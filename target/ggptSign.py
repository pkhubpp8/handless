...
class signClass(signBase):
    def __init__(self, driver, url = 'https://www.gamegamept.com/index.php', module_name: str = 'ggptSign'):
        self.indexUrl = url
        self.driver = driver
        self.module_name = module_name
        super().__init__("gamegamept")
    ...
    def sign(self):
        ...
        for element in elements:
            if element.text == '[签到得G值]':
                element.click()
                break
    def validSign(self):
        if not re.search('GGPT', self.driver.title):
