...
class signClass(signBase):
    def __init__(self, driver, url = 'https://ultrahd.net/index.php', module_name: str = 'ultraHDSign'):
        self.indexUrl = url
        self.driver = driver
        self.module_name = module_name
        super().__init__("ultrahd")
    ...
    def sign(self):
        ...
        for element in elements:
            if element.text == '[签到得魔力]' and 'attendance.php' in element.get_attribute("href"):
                ...
                break
    def validSign(self):
        if not re.search('UltraHD.*NexusPHP', self.driver.title):
